...
SEARCH_SPACE = {
  ...
  "parallel_envs": ("categorical", [False]),
  ...
  "total_timesteps": ("float", (1e5, 1e7), {"log": True}),
  "learning_rate": ("float", (1e-5, 1e-2), {"log": True}),
  "unroll_length": ("categorical", [2048]),  # Fixed for REINFORCE
  "anneal_lr": ("categorical", [True, False]),
  "gamma": ("float", (0.95, 0.999), {"step": 0.001}),
  "batch_size": ("categorical", [1]),  # Fixed for REINFORCE
  "num_minibatches": ("categorical", [1]),  # Fixed for REINFORCE
  "update_epochs": ("categorical", [1]),  # Fixed for REINFORCE
  "entropy_cost": ("float", (0.0, 0.02), {"step": 0.001}),
  "max_grad_norm": ("float", (0.1, 1.0), {"step": 0.1}),
  "reward_scaling": ("float", (0.1, 10.0), {"log": True}),
  # Policy parameters
  "policy_hidden_layer_sizes": ("categorical_seq", [2 * 32, 4 * 32, 3 * 64]),
